...
class FlutterWebviewPlugin {
  ...
  final _onJavascriptCalled = StreamController<Map<String,dynamic>>.broadcast();
  ...
  Future<Null> _handleMessages(MethodCall call) async {
    switch (call.method) {
      ...
      case 'onUrlChanged':
        ...
        break;
      case 'onJavascriptCalled':
        _onJavascriptCalled.add({
          'method':call.arguments['method'],
          'argument':call.arguments['argument'],
        });
        break;
  ...
  /// Listening javascript called
  Stream<Map<String,dynamic>> get onJavascriptCalled => _onJavascriptCalled.stream;
